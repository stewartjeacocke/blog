---
layout: post
title:  "The seven keys to successful projects?"
---
...
![The Seven Keys to Success]({{ 'assets/7-keys-hud.png' | relative_url }})



You can read more in the [original 2002 whitepaper]({{ 'assets/ibm-7keys.pdf' | relative_url }}).
